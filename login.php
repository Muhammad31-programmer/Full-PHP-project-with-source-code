...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      <form  method="post">
        <?php require('code/user_login.php')   ?>
        ...
        <div class="col-4">
            <button type="submit" name="user" class="btn btn-primary btn-block">Login</button>
          </div>
      </form>
      <a href="register.php" class="text-center">Registered As New User</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
